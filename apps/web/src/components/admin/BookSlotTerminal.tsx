  ...
  const handleBookingSubmit = async (mode: 'cash' | 'card' | 'none', isBlackout = false) => {
    ...
    try {
      ...
      if (isBlackout) {
        ...
        payload.blackoutReason = customerName || 'Court Maintenance';
      }
      ...
      setConfirmedBooking({
        reference: json.reference || 'PC-BLACKOUT',
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-surface rounded-lg border border-border shadow-sm p-6 space-y-6">
        ...
        {/* Step 3: Customer Details (Phone first!) */}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-2 rounded border border-border bg-surface text-ink text-sm font-mono focus:outline-hidden focus:border-navy"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-2 rounded border border-border bg-surface text-ink text-sm focus:outline-hidden focus:border-navy"
                />
              </div>
            </div>
          </div>
                ...
                <div className="p-3 rounded bg-surface-2 border border-border space-y-2 text-xs">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="w-32 px-2.5 py-1.5 rounded border border-border bg-surface text-ink text-xs font-mono"
                    />
                    <input
                      type="text"
                      ...
                      className="flex-1 px-2.5 py-1.5 rounded border border-border bg-surface text-ink text-xs"
                    />
                  </div>
                </div>
              )}
        ...
        <div className="pt-4 border-t border-border space-y-2">
          ...
          <div className="flex items-center gap-4">
            <label className="flex items-center gap-2 cursor-pointer p-3 rounded border border-border bg-surface hover:bg-surface-2 transition flex-1">
              <input
                type="radio"
                name="paymentMode"
                value="cash"
        ...
        <div className="pt-6 border-t border-border space-y-3">
          <button
            ...
            className="w-full py-3.5 px-4 rounded bg-navy text-white font-bold text-sm hover:opacity-90 transition shadow-md disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
              ...
              <span>Payment received — block slot</span>
            )}
          </button>
          ...
          <div className="flex items-center justify-center gap-6 text-xs pt-1">
            ...
            >
              Block without payment (Pay later)
            </button>
            ...
            <button
              ...
              className="text-ink-soft hover:text-danger transition underline font-medium"
            >
              Blackout this slot (Maintenance)
            </button>
          </div>
        </div>
      </div>
